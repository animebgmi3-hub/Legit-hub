...
UppercutTab:Button({
    Title = "King tech",
    Callback = function()
        loadstring(game:HttpGet("https://api.jnkie.com/api/v1/luascripts/public/db1e974cdf7fab0c8fc113c38350c94ed7d7466d617bb372e44f6acdd5fce0ea/download"))()
    end,
})
...
UppercutTab:Button({
    Title = "Lix tech",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/dinhthanhtuankiet1762009-sudo/Js/refs/heads/main/aca40cf1f24c92f1.lua.txt"))()
    end,
})
...
local LethalTab = Window:Tab({ Title = "Lethal techs", Icon = "target" })
...
MovementTab:Button({
    Title = "Backdash",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/dinhthanhtuankiet1762009-sudo/Js/refs/heads/main/4418648b0e9b71ef.lua"))()
    end,
})
